...
public class Manga {
	...
	public Manga(int id, String titulo, String autor, String genero,  int numeroVolumenes,int anioPublicacion,
			boolean bestseller) {
		super();
		this.id = id;
		this.titulo = titulo;
	...
	public String toString() {
		return "Manga [id=" + id + ", titulo=" + titulo + ", autor=" + autor + ", genero=" + genero
				+ ", anioPublicacion=" + anioPublicacion + ", numeroVolumenes=" + numeroVolumenes + ", bestseller="
				+ bestseller + "]";
	}
