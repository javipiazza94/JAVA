...
public class Actividad_TEMA_1 {
    public static void contar_lineas(File fichero) {
		try {
			int lineas_totales = 0;
			String linea_leida;
			if (fichero.exists()) {
				BufferedReader lectura = new BufferedReader(new FileReader (fichero));
				while ((linea_leida = lectura.readLine())!= null) {
					lineas_totales = lineas_totales+1;
				}
					System.out.println("El numero de lineas es de " +lineas_totales);
	...
	public static void contar_parrafos(String frase) {
		int contador_parrafos = 0;
		if (frase.contains("\n")) {
			contador_parrafos++;
			System.out.println("El texto contiene "+contador_parrafos+ " parrafos");
		}else {
			System.out.println("No contiene parrafos");
		}
	}
	...
	public static void main(String[] args) {
		...
		try{
			File lectura = new File ("C:\\Users\\Usuario\\Desktop\\Actividad_TEMA 1\\"  + "Actividad_File.txt");
			...
			System.out.println();
			Actividad_TEMA_1.contar_lineas(lectura);
			Actividad_TEMA_1.contar_parrafos(frase);
