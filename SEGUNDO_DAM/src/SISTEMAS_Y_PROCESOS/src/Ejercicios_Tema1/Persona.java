...
public class Persona {
	...
	public Persona(String name, char sex, int age, double weight, double height) {
		this.sexo = this.comprobarSexo(sex); // (sex.toUpperCase()).charAt(0) --> Coge solo la primera letra
		this.edad = age;
		this.nombre = name;
		this.peso = weight;
		this.altura = height;
	...
	public Persona(String name, char sex, int age) {
		this.sexo = this.comprobarSexo(sex);
		this.edad = age;
		this.nombre = name;
		this.peso = 78;
		this.altura = 1.78;
	...
	public boolean CompararDNI(Persona persona2) {
