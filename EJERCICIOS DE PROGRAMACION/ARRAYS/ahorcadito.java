...
public class ahorcadito {
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in);
		 ...
		 String [] palabras = {"bitcoin", "ethereum", "cardano"}; //Hacemos un String con array de las 3 palabras a elegir 
		 Random r1 = new Random(); //Importamos el Random para que la maquina elija a una de las 3 palabras 
		 int numero =r1.nextInt(palabras.length); // Le decimos a la maquina que elija el numero de las palabras 
		 String PalabraSecreta= palabras[numero]; //Le decimos que elija la palabra secreta entre el numero de palabras que hay
