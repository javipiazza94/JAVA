...
public class EJERCICIO_FICHEROS {
	public static void main(String[] args) {
		...
		try {
			File fichero = new File("C:\\Users\\javip\\OneDrive\\Escritorio\\PRUEBA ECLIPE FICHERO\\" + doc);
		...
		try {
			FileWriter escritura = new FileWriter(
					"C:\\Users\\javip\\OneDrive\\Escritorio\\PRUEBA ECLIPE FICHERO\\" + doc);
		...
		// HACEMOS SU LECTURA
		try {
			File lectura = new File("C:\\Users\\javip\\OneDrive\\Escritorio\\PRUEBA ECLIPE FICHERO\\" + doc);
		...
		File carpeta = new File("C:\\Users\\javip\\OneDrive\\Escritorio\\PRUEBA ECLIPE FICHERO\\");
		...
		// MISMO PROCESO CON EL FICHERO DE LA CARPETA HIJA
		System.out.println("Introduce el nombre del fichero a crear dentro de la subcarpeta");
		String doc2 = sc.nextLine();
		try {
			File ficherocarpeta2 = new File(
					"C:\\Users\\javip\\OneDrive\\Escritorio\\PRUEBA ECLIPSE FICHERO\\POLLO LE DABA" + doc2);
