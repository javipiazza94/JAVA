...
DROP TABLE ENCARGO CASCADE CONSTRAINTS;
...
CREATE TABLE FAENA (ID_FAENA NUMBER (9)
                    ...
                    ,CONSTRAINT FK_ENCARGO2 FOREIGN KEY (ID_ENCARGO) REFERENCES ENCARGO(ID_ENCARGO));
...
CREATE TABLE COLABORACION (ID_COLABORACION NUMBER (9)
                          ...
                          ,CONSTRAINT FK_SECCION2 FOREIGN KEY (ID_SECCION) REFERENCES SECCION(ID_SECCION)
                          ,CONSTRAINT FK_MOTOR2 FOREIGN KEY (ID_MOTOR) REFERENCES MOTOR(ID_MOTOR));
...
CREATE TABLE COMPOSICION (ID_COMPOSICION NUMBER (9)
                          ...
                          ,CONSTRAINT FK_MOTOR3 FOREIGN KEY (ID_MOTOR) REFERENCES MOTOR(ID_MOTOR)
