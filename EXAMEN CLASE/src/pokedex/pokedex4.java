				...
				if (rutas.equals("i")) {
					...
					if (capturas.equals("si")) {
						...
						if (tipoball.equals("poke ball")){
							...
							+ " no ha sido capturado y se ha escapado. Puedes marcharte, " + rutalegendaria.get(pokerandm)
							+ " se ha almacenado en tu Pokédex");break;
					...
					if (capturas2.equals("si")){
						...
						if (tipoball.equals("poke ball")){
							...
							+ " no ha sido capturado y se ha escapado. Puedes marcharte, " + rutamatados.get(pokerandm2)
							+ " se ha almacenado en tu Pokédex");break;
