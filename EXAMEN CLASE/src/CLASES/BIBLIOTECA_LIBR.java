		...
		//METODO PRESTAMOS
				...
				public boolean IsDisponible(){
					if (this.disponible = true){
						System.out.println("Su libro está disponible para el préstamo");
					}else {
						System.out.println("Su libro no está disponible para el préstamo");
					}
		...
		//METODO COMPROBAR NPAGINAS
				...
				public void ComprobarNPaginas(BIBLIOTECA_LIBR libroA, BIBLIOTECA_LIBR libroB){
					if (libroA.NPaginas>libroB.NPaginas){
						System.out.println("El "+libroA+" tiene más paginas que el "+libroB+"");
					}else if (libroA.NPaginas==libroB.NPaginas){
							System.out.println("El "+libroA+" tiene las mismas paginas que el "+libroB+"");
					}else {
						System.out.println("El "+libroB+" tiene más paginas que el "+libroA+"");
					}
				}
