...
public class CUBATA {
	...
	//METODOS 
		...
		public CUBATA plus (CUBATA cubata2){
			String bebidaalcoholica = this.bebidaalcoholica +" y " +cubata2.bebidaalcoholica;
			String refresco = this.refresco+ "y" +cubata2.refresco;
			int cantidad = this.cantidad + cubata2.cantidad;
