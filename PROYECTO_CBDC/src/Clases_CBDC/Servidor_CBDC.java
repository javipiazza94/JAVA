...
public class Servidor_CBDC extends JFrame {
	...
	private JTextField cantidad_prestar;
	...
	public Servidor_CBDC() {
		...
		Image imagen = pantalla.getImage(
				"C:\\Users\\javip\\OneDrive\\Documents\\DAM\\ACTIVIDADES\\EJERCICIOS DE PROGRAMACIÓN\\JAVA\\PROYECTO_CBDC\\src\\IMAGENES\\euro.png");
		setIconImage(imagen);
		...
		bce_logo.setIcon(new ImageIcon(
				"C:\\Users\\javip\\OneDrive\\Documents\\DAM\\ACTIVIDADES\\EJERCICIOS DE PROGRAMACIÓN\\JAVA\\PROYECTO_CBDC\\src\\IMAGENES\\European-Central-Bank-logo.jpg"));
		...
		JLabel prestamo = new JLabel("Introduce la cantidad a prestar a cada cuenta");
		prestamo.setForeground(Color.BLUE);
		prestamo.setFont(new Font("Verdana", Font.BOLD, 11));
		prestamo.setBounds(10, 300, 299, 27);
		...
		cantidad_prestar.setBounds(315, 304, 137, 23);
		...
		Prestar.setBounds(462, 303, 88, 25);
