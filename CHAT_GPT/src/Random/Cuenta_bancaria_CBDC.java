...
public class Cuenta_bancaria_CBDC {
		...
		public Cuenta_bancaria_CBDC(String numeroCuenta, String nombreTitular, double saldoInicial,
			...
			this.operativa = true;
			this.tipoInteres = obtenerInteresBancoCentral();
		...
		public double obtenerInteresBancoCentral() {
			Banco_Central_CBDC bancoCentral = new Banco_Central_CBDC();
		    return obtenerInteresBancoCentral();
		}
		...
		public String generarNumeroIBAN() {
			...
			numeroIBAN = numeroIBAN.replaceAll("[^\\d]", "");
		...
		public static void main(String[] args) {
			...
			Cuenta_bancaria_CBDC cuenta1 = new Cuenta_bancaria_CBDC("123456", "Juan Pérez", 1000.0, 10000.);
			Cuenta_bancaria_CBDC cuenta2 = new Cuenta_bancaria_CBDC("654321", "Ana Martínez", 2000.0, 15000.0);
			...
			System.out.println("En Numero IBAN es: "+cuenta1.obtenerNumeroIBAN());
			...
			System.out.println("El tipo de interes es el " + cuenta1.obtenerInteresBancoCentral() + " por ciento");
			System.out.println();

			System.out.println("Información de la cuenta 2:");
			System.out.println("Número de cuenta: " + cuenta2.obtenerNumeroCuenta());
			System.out.println("En Numero IBAN es: "+cuenta2.obtenerNumeroIBAN());
			...
			System.out.println("El tipo de interes es el " + cuenta2.obtenerInteresBancoCentral() + " por ciento");
			System.out.println();
			...
			System.out.println("El DNI del titular es: " + cuenta2.obtenerDNI());
			System.out.println("Saldo: " + cuenta2.obtenerSaldo());
			System.out.println("El tipo de interes es del  " + cuenta2.obtenerInteresBancoCentral() + " por ciento");
